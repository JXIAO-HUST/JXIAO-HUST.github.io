...
3.	**JiangZiya: Dependency-aware Smart Contract Migration for Scalable Sharded Blockchains**
...
4.	**Turbo: Optimistic Execution Framework for Low-Latency Cross-Chain Transactions**
...
5.	**MorphDAG: A Workload-Aware Elastic DAG-based Blockchain**
...
6.	**Wahoo: A DAG-based BFT Consensus with Low Latency and Low Communication Overhead**
...
7.	**FLUID: Towards Efficient Continuous Transaction Processing in DAG-based Blockchains**
...
8.	**Detecting Arbitrage on Ethereum Through Feature Fusion and Positive-Unlabeled Learning**
...
22.	**Enabling Complete Atomicity for Cross-chain Applications Through Layered State Commitments**
